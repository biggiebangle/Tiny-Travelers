...
+ (Levels *)loadLevelsForChapter:(int)chapter {
    ...
    for (GDataXMLElement *element in dataArray) {
        ...
        NSArray *descriptionArray = [element elementsForName:@"Description"];
        ...
        if (descriptionArray.count > 0) {
            GDataXMLElement *descriptionElement = (GDataXMLElement *) [descriptionArray objectAtIndex:0];
...
+ (void)saveData:(Levels *)saveData 
    ...
    for (Level *level in saveData.levels) {
        ...
        GDataXMLElement *descriptionElement = [GDataXMLNode elementWithName:@"Description"
                                                         stringValue:level.description];
        ...
        [levelElement addChild:descriptionElement];
    ...
    GDataXMLDocument *document = [[GDataXMLDocument alloc]
                                   initWithRootElement:levelsElement];
